...
// Function to generate white noise using NEON (if required)
// Uncomment and use if you prefer generating white noise instead of reading WAV files
/*
...
int main() {
    ...
    */
    ...
    if (!saveFeatureMatrixToCSV(standardizedFeatureMatrix, featureFilePath, FEATURE_NAMES)) {
        return -1;
    }
